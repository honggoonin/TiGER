...
#define LOG_K_1 7
#define LOG_K_2 2
#define HR 196			// Hamming weight of coefficient vector r
#define HS 196			// Hamming weight of coefficient vector s
#define HE 32
#define SEED_LEN 32
#define KK_LEN 32
...
#define SECRETKEYSIZE 246+MESSAGE_LEN // LOG_N*HS/8+1
