...
#define PUBLICKEYSIZE 32+(LOG_P*LWE_N/8)//LWE_N // 
#define SECRETKEYSIZE 161+MESSAGE_LEN//LWE_N+MESSAGE_LEN 
#define CIPHERTEXTSIZE (LOG_K_1*LWE_N/8) + (LOG_K_2*LWE_N/8) // LWE_N*2 // 384+256 = 640
