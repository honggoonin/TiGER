...
TiGER128 = [512, 256, min(104, 104)]
#TiGER128 = [512, 256, min(84, 84)]
TiGER192 = [1024, 256, min(116, 116)]
#TiGER192 = [1024, 256, min(104, 104)]
TiGER256 = [1024, 256, min(184, 184)]
#TiGER256 = [1024, 256, min(156, 156)]
...
tm128 = meet_lwe_rep0(TiGER128[0], TiGER128[1], TiGER128[2])
tm192 = meet_lwe_rep0(TiGER192[0], TiGER192[1], TiGER192[2])
tm256 = meet_lwe_rep0(TiGER256[0], TiGER256[1], TiGER256[2])
print(f"TiGER128: time= {tm128[0]:4.1f} = {tm128[1]:4.1f} + {tm128[2]:4.1f}, memory= {tm128[3]:4.1f}")
print(f"TiGER192: time= {tm192[0]:4.1f} = {tm192[1]:4.1f} + {tm192[2]:4.1f}, memory= {tm192[3]:4.1f}")
print(f"TiGER256: time= {tm256[0]:4.1f} = {tm256[1]:4.1f} + {tm256[2]:4.1f}, memory= {tm256[3]:4.1f}")
# 
# ###########################
...
tm128 = meet_lwe_rep1_for(TiGER128[0], TiGER128[1], TiGER128[2])
tm192 = meet_lwe_rep1_for(TiGER192[0], TiGER192[1], TiGER192[2])
tm256 = meet_lwe_rep1_for(TiGER256[0], TiGER256[1], TiGER256[2])
print(f"TiGER128: time= {tm128[0][0]:4.1f} = {tm128[0][1]:4.1f} + {tm128[0][2]:4.1f}, memory= {tm128[0][3]:4.1f} with {tm128[1]}")
print(f"TiGER192: time= {tm192[0][0]:4.1f} = {tm192[0][1]:4.1f} + {tm192[0][2]:4.1f}, memory= {tm192[0][3]:4.1f} with {tm192[1]}")
print(f"TiGER256: time= {tm256[0][0]:4.1f} = {tm256[0][1]:4.1f} + {tm256[0][2]:4.1f}, memory= {tm256[0][3]:4.1f} with {tm256[1]}")
# 
# ###########################
...
tm128 = meet_lwe_rep2_for(TiGER128[0], TiGER128[1], TiGER128[2])
tm192 = meet_lwe_rep2_for(TiGER192[0], TiGER192[1], TiGER192[2])
tm256 = meet_lwe_rep2_for(TiGER256[0], TiGER256[1], TiGER256[2])
print(f"TiGER128: time= {tm128[0][0]:4.1f} = {tm128[0][1]:4.1f} + {tm128[0][2]:4.1f}, memory= {tm128[0][3]:4.1f} with {tm128[1]}")
print(f"TiGER192: time= {tm192[0][0]:4.1f} = {tm192[0][1]:4.1f} + {tm192[0][2]:4.1f}, memory= {tm192[0][3]:4.1f} with {tm192[1]}")
print(f"TiGER256: time= {tm256[0][0]:4.1f} = {tm256[0][1]:4.1f} + {tm256[0][2]:4.1f}, memory= {tm256[0][3]:4.1f} with {tm256[1]}")
