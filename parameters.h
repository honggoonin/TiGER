...
#define NOISE_D2//D1                // discrete Gaussian sampling option
#define MSG_BYTES 16//32

#define LOG_Q 10                // public key modulus
#define LOG_P2 3//5                // ciphertext2 modulus
#define HS 100//140                  // Hamming weight of coefficient vector s
#define HR 132                  // Hamming weight of coefficient vector r
#define Modulus_Q 2^LOG_Q

#define RD_ADD2 0x1000//0x0400          // 2^(15 - LOG_P2)                 // EDIT_TiMER
#define RD_AND2 0xe000//0xf800          // 2^16 - 2^(16 - LOG_P2)          // EDIT_TiMER
